...
ID  & GHz                     & FWHM       &      & \\[0.1cm]
\hline \\[-0.25cm]
2a & 88.14 \pm 0.17\footnote{I know the significant digits are wrong for my uncertainties but I wanted a little more precision (otherwise everything ends up being a single digit later on when the errors propagate).} & 0.57 \pm 0.43 & 1.11E-04 & 2.923 \pm .007  \\
