...
\usepackage[top=2.cm, bottom=3.cm, left=2.5cm, right=2.5cm]{geometry}
...
\hline \\[-0.25cm]
2a & $<(4.57 \pm 0.02)\times 10^{6}$  & $<(2.10 \pm 0.01)\times 10^{7}$  & 2.86 & $<(7.34 \pm 0.03)\times 10^{6}$  \\
2b & $(8.541 \pm 0.005)\times 10^{6}$ & $(3.929 \pm 0.002)\times 10^{7}$ & 8.1  & $(4.851 \pm 0.003)\times 10^{6}$ \\
2c & $(6.784 \pm 0.002)\times 10^{6}$ & $(3.121 \pm 0.001)\times 10^{7}$ & 6.1  & $(5.116 \pm 0.002)\times 10^{6}$ \\
\hline
\end{tabular}
